...
\newcommand{\ga}{\ensuremath{\diamond}}
...
\begin{problem}[Higher-order $\beta$-Matching (${F}\,X = N$)]
...
\begin{problem}[$0^+ \Rightarrow^*_\calR 1^+$]
...
\end{itemize}
\item present $A_\calR$ as a higher-order $\beta$-matching instance $\calM_\calR$
\begin{itemize}
\item $\calM_\calR$ is solvable iff $0^+ \Rightarrow^*_\calR 1^+$
\end{itemize}
