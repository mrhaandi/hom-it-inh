...
\item $\delta_i := \lambda x.\lambda r_1 \ldots r_K.\itb{x}{\top}{r_i}$
\end{itemize}
...
%  ring2 m M.
$M$ is in normal form, $\Gamma_A \vdash M : A$
\begin{itemize}
\item[(4)] $M\,H_{00 \Rightarrow 21}\,H_{02 \Rightarrow 11}\,H_{0}\,\pi_{1}\,H_\smile\,H^{\top}_{\bullet} =_\beta \pi_{\dag}$
\item[(5)] $M\,I\,I\,(\lambda h.I)\,u\,(\lambda h.\lambda g.g\,I)\,I =_\beta u$
\end{itemize}
implies $M = \lambda x_1 \ldots x_n.\lambda y z a b.N$ and 
...
\begin{itemize}
\item[(4)] $M\,H_{00 \Rightarrow 21}\,H_{02 \Rightarrow 11}\,H_{0}\,\pi_{1}\,H_\smile\,H^{\top}_{\bullet} =_\beta \pi_{\dag}$
\item[(5)] $M\,I\,I\,(\lambda h.\lambda x.x)\,u\,(\lambda h.\lambda g.g\,I)\,I =_\beta u$
\end{itemize}
implies $M$ is ring1
\end{lemma}
