...
For $m, k \in \bbN$ let $\calQ_m$ and $\calR_m$ be the smallest sets of terms satisfying the following rules.
\begin{itemize}
...
\end{array}$\\
then $M = \lambda r_1 \ldots r_k.\lambda z_\0 z_\1 z_\star x_p^1.N$ for some $k \in \bbN$ such that $N \in \calR_1$.
\end{theorem}
