...
By omitting the last clause of case we mean (???) \[\case{x}{i_1 \mapsto t_1 \mid \ldots \mid i_k \mapsto t_k} := \caseelse{x}{i_1 \mapsto t_1 \mid \ldots \mid i_k \mapsto t_k}{r_\bot ?}\]
...
\[(\lambda x.\lambda y.y\,(x\,F_\star\,F_\0\,F_{R_1} \ldots F_{R_k}) (x\,G_\star\,G_\0\,G_{R_1} \ldots G_{R_k}\,G_\1))\,X = \lambda y.y\,(\lambda z.z)\,\pi_\$\]
