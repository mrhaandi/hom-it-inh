...
The present work presents a novel undecidability proof for higher-order $\beta$-matching, in an effort to verify this result by means of a proof assistant in full detail.
...
Additionally, undecidability of Problem $\0^+ \Rightarrow^* \1^+$ is already mechanized, and is part the Coq Library of Undecidability Proofs.
