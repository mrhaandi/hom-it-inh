...
The following Example~\ref{xmp:G_R} complements Example~\ref{xmp:G_Q} and illustrates the intended meaning (word expansion and initialization) of a \enquote{well-formed} example term in $\calR_1$ under the substitution $S_G$.
