...
\end{array}$\\
then $M = \lambda r_1 \ldots r_L.\lambda z_\0 z_\1 z_\star p_1.N$ for some $k \in \bbN$ such that $N \in \calR_1$.
\end{theorem}
...
$\begin{array}{lllllllll}
M[z_\star := G_\star, z_\1 := \pi_\1, z_\0 := G_\0, r_1 := G_{R_1}, \ldots, r_L := G_{R_k}, p_1 := \delta_\bullet] =_\beta \pi_\$,\\
M[z_\star := G_\star, z_\1 := \pi_\1, z_\0 := G_\0, r_1 := G_{R_1}, \ldots, r_L := G_{R_k}, p_1 := \delta_\0] =_\beta \pi_\1,\\
M[z_\star := G_\star, z_\1 := \pi_\1, z_\0 := G_\0, r_1 := G_{R_1}, \ldots, r_L := G_{R_k}, p_1 := \delta_\1] =_\beta \pi_\0,
\end{array}$\\
then there exists an $m > 0$ and an $N \in \calQ_m$ such that\\
$\begin{array}{lllllllll}
\Gamma_m \vdash N : \kappa,\\
N[z_\star\hspace{0pt}:=\,\!G_\star, z_\1 := \pi_\1, z_\0 := G_\0, r_1 := G_{R_1}, \ldots, r_L := G_{R_k}, p_1 := G_1^0, \ldots, p_m := G_m^0] =_\beta \pi_\1,\\
N[z_\star := G_\star, z_\1 := \pi_\1, z_\0 := G_\0, r_1 := G_{R_1}, \ldots, r_L := G_{R_L}, p_1 := G_1^i, \ldots, p_m := G_m^i] =_\beta \pi_\0\\
...
$\begin{array}{lllllllll}
M[z_\star := G_\star, z_\1 := \pi_\1, z_\0 := G_\0, r_1 := G_{R_1}, \ldots, r_L := G_{R_L}, p_1 := G_1^0, \ldots, p_m := G_m^0] =_\beta \pi_\1,\\
M[z_\star := G_\star, z_\1 := \pi_\1, z_\0 := G_\0, r_1 := G_{R_1}, \ldots, r_L := G_{R_L}, p_1 := G_1^i, \ldots, p_m := G_m^i] =_\beta \pi_{a_i}\\
...
\begin{theorem}
Exists $n$ such that $\0^{n+1} $ rewrites to $\1^{n+1}$ iff
