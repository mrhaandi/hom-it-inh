...
\acknowledgements{I cincerely thank the anonymous reviewers for their constructive suggestions.}%optional
...
%This entails a certified many-one reduction from the Turing machine Halting Problem to higher-order $\beta$-matching.
...
\begin{itemize}
\item $\delta_i$ for $i \in \calA$ realizes a member of the finite function family specified by the partial function table ${\setlength{\arraycolsep}{1pt}\small\left(\begin{array}{l}
\top \mapsto i\end{array}\right)}$.
\item $G_\0$ realizes a member of the family specified by ${\small\left(\begin{array}{l}
...
\end{array}\right)}$.
\item $G_{ab \Rightarrow cd}$ realizes a member of the family specified by ${\small\left(\begin{array}{l}
...
\item $G_\star$ realizes a member of the family specified by ${\setlength{\arraycolsep}{1pt}\small\left(\begin{array}{l}
...
Interaction with a proof assistant supported the conception of the present approach both on an intuitive and on the technical level.
