...
Our approach is to construct simply typed terms which capture the two main aspects of the rewriting problem $\0^+ \Rightarrow^* \1^+$: the search for a sufficiently long starting sequence of $\0$s, and the individual rewriting steps to the resulting sequence of $\1$s.
