...
In the present work, we focus on a fragment, which can be identified identified by inspection of intersection types occurring in the undecidability of intersection type inhabitation~\cite{Urzyczyn09,DudenhefnerR19} and their relationship to fine model theory~\cite{SalvatiMGB12}.
